...
def send_email():
    msg = Message(
        'App Engine Flask-Mail demo version 1',
        #'App Engine Flask-Mail demo version 2',
        #'App Engine Flask-Mail demo version 3',
        recipients=[recipient],
        body='This is a version 1 test message sent from minimal_flaskmail.'
        #body='This is a version 2 test message sent from minimal_flaskmail.'
        #body='This is a version 3 test message sent from minimal_flaskmail.'
    )
    mail.send(msg)
    return 'Email sent!'
